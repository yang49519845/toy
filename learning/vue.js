...
(function (global, factory) {
  ...
  function initRender(vm) {
    ...
    // 参数顺序：[ 标记、数据、子项、规格 ]化类型、AlwaysOrmalize
    // 内部版本由从模板编译的呈现函数使用
    ...
    // $attrs和$listeners是公开的，以便更轻松地创建HOC。
    // 它们必须是被动的，这样使用它们的HOC总是更新的
   ...
   *
   * 
   * @description 合并 option 执行init函数
   * 
   * @param {*} Vue
   */
